...
module.exports = new Type('tag:yaml.org,2002:bool', {
  ...
  dumper: {
    ...
    representer: {
      lowercase: function (object, style) { return object ? 'true' : 'false'; },
      uppercase: function (object, style) { return object ? 'TRUE' : 'FALSE'; },
      camelcase: function (object, style) { return object ? 'True' : 'False'; }
    }
  }
});
