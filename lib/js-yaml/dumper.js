...
QUOTED_SEQUENCES[0x00]   = '\\0';
QUOTED_SEQUENCES[0x07]   = '\\a';
QUOTED_SEQUENCES[0x08]   = '\\b';
QUOTED_SEQUENCES[0x0B]   = '\\v';
QUOTED_SEQUENCES[0x0C]   = '\\f';
QUOTED_SEQUENCES[0x1B]   = '\\e';
QUOTED_SEQUENCES[0x22]   = '\\"';
QUOTED_SEQUENCES[0x5C]   = '\\\\';
QUOTED_SEQUENCES[0x85]   = '\\N';
QUOTED_SEQUENCES[0xA0]   = '\\_';
QUOTED_SEQUENCES[0x2028] = '\\L';
QUOTED_SEQUENCES[0x2029] = '\\P';
...
function dump(input, options) {
  ...
  function writeScalarFull(level, object) {
    ...
    result = '';
    style = STYLE_PLAIN; // Supports plain, literal, quoted.
    checkpoint = 0;
