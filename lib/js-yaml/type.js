...
function Type(tag, options) {
  ...
  this.loadValidate     = options['loadValidate']     || function () { return true; };
  this.loadCreate       = options['loadCreate']       || function (data) { return data; };
  this.dumpInstanceOf   = options['dumpInstanceOf']   || null;
  this.dumpPredicate    = options['dumpPredicate']    || null;
  this.dumpRepresent    = options['dumpRepresent']    || null;
