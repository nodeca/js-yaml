...
exports.Scanner = new JS.Class('Scanner', {
  ...
  */
  ...
  scanFlowScalarNonSpaces: function (double, start_mark) {
  /*
    # See the specification for details.
    chunks = []
    while True:
  ...
  scanFlowScalarSpaces: function (double, start_mark) {
  /*
    # See the specification for details.
    chunks = []
    length = 0
  ...
  scanFlowScalarBreaks: function (double, start_mark) {
  /*
    # See the specification for details.
    chunks = []
    while True:
  ...
  scanPlainSpaces: function (indent, start_mark) {
  /*
    # See the specification for details.
  ...
  scanTagHandle: function (name, start_mark) {
  /*
    # See the specification for details.
  ...
  scanTagUri: function (name, start_mark) {
  /*
    # See the specification for details.
  ...
  scanUriEscapes: function (name, start_mark) {
  /*
    # See the specification for details.
    codes = []
    mark = self.get_mark()
