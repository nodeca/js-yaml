...
function ScannerError() {
  __.MarkedYAMLError.apply(this, arguments);
  this.name = 'ScannerError';
}
$$.inherits(ScannerError, __.MarkedYAMLError);
...
exports.Scanner = new JS.Class('Scanner', {
  ...
  scanDirective: function () {
    ...
    return new __.DirectiveToken(name, value, startMark, endMark);
  },
  ...
  scanBlockScalarIgnoredLine: function (startMark) {
    var ch;
