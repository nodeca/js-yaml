...
BaseResolver.prototype.resolve = function resolve(kind, value, implicit) {
  ...
  if (kind === _nodes.ScalarNode && implicit[0]) {
    if (value === '') {
      resolvers = this.constructor.yamlImplicitResolvers[''] || [];
    } else {
      resolvers = this.constructor.yamlImplicitResolvers[value[0]] || [];
    }

    resolvers = resolvers.concat(this.constructor.yamlImplicitResolvers[null] || []);
...
function Resolver() { BaseResolver.apply(this, arguments); }
