...
$$.decodeBase64 = (function () {
  ...
  return function decode(data) {
    ...
    for (i = 0; i < data.length; i++) {
      if (10 === data.charCodeAt(i)) { // new line charcter (\n)
        continue;
      }
      ...
      if (c === -1) {
        throw new Error("Illegal characters (code=" + data.charCodeAt(i) + ") in position " + i + ": ordinal not in range(128)");
      }
