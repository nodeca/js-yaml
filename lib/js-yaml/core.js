...
var ESSENTIAL_PROPS = ['arguments', 'length', 'name', 'prototype', 'caller'];
...
$$.inherits = function inherits(child, parent) {
  $$.merge(child, parent, {except: ESSENTIAL_PROPS});

  function InheritanceGlue(){};
  ...
  $$.merge(child.prototype, parent.prototype, {except: ESSENTIAL_PROPS});
  
  // restore constructor
  $$.merge(child.prototype, {constructor: child});
...
$$.import = function import_modules() {
  ...
  for (i = 0; i < arguments.length; i++) {
    ...
    Object.getOwnPropertyNames(mod).forEach(iterator);
  }
